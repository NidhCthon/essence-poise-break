...
export {
  ...
  DEFEAT_DURATION, DEFEAT_SLOW, DEFEAT_SLOW_SPEED, DEFEAT_REPEAT, defeatStatuses,
  isDefeatEffect, defeatEffectTokens, defeatCombatantTokens, firstDefeat, defeatedAt,
  defeatTextFrame, createDefeatText, slowMotion, drainScreen, playDefeat, playDefeats,
  POISE_NUMBER_DURATION, POISE_NUMBER_SIZE_MIN, POISE_NUMBER_SIZE_MAX, POISE_NUMBER_STACK,
  ...
  AURA_FLAMES, AURA_FLAMES_ICONIC, AURA_REACH, AURA_REACH_ICONIC, AURA_FADE,
  auraLevel, auraFlameLayout, auraFade, drawAura, auras, wantedAuras, syncAuras,
  tickAuras, clearAuras,
